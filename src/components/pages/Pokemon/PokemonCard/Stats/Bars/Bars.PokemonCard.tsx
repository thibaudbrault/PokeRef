          ...
          <tr>
            ...
            <PokemonStatsBars>
              <div>
                <span
                  style={{
                    width: `calc(${pokemon?.stats?.[0]?.base_stat} / 180 * 100%)`,
                  }}
                ></span>
              </div>
            </PokemonStatsBars>
          ...
          <tr>
            ...
            <PokemonStatsBars>
              <div>
                <span
                  style={{
                    width: `calc(${pokemon?.stats?.[1]?.base_stat} / 180 * 100%)`,
                  }}
                ></span>
              </div>
            </PokemonStatsBars>
          ...
          <tr>
            ...
            <PokemonStatsBars>
              <div>
                <span
                  style={{
                    width: `calc(${pokemon?.stats?.[2]?.base_stat} / 180 * 100%)`,
                  }}
                ></span>
              </div>
            </PokemonStatsBars>
          ...
          <tr>
            ...
            <PokemonStatsBars>
              <div>
                <span
                  style={{
                    width: `calc(${pokemon?.stats?.[3]?.base_stat} / 180 * 100%)`,
                  }}
                ></span>
              </div>
            </PokemonStatsBars>
          ...
          <tr>
            ...
            <PokemonStatsBars>
              <div>
                <span
                  style={{
                    width: `calc(${pokemon?.stats?.[4]?.base_stat} / 180 * 100%)`,
                  }}
                ></span>
              </div>
            </PokemonStatsBars>
