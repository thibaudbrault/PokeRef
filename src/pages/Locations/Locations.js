            ...
            {loading ? (
                ...
                <>
                    <LocationNav>
                        ...
                        <button className={toggleState === 3 ? 'button_active' : ''} onClick={() => toggleTable(3)}><p>Hoenn</p></button>

                        <button className={toggleState === 4 ? 'button_active' : ''} onClick={() => toggleTable(4)}><p>Sinnoh</p></button>

                        <button className={toggleState === 5 ? 'button_active' : ''} onClick={() => toggleTable(5)}><p>Unova</p></button>

                        <button className={toggleState === 6 ? 'button_active' : ''} onClick={() => toggleTable(6)}><p>Kalos</p></button>
