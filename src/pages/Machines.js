                ...
                {loading ? (
                    <BarWave width='40px' height='20px' color='#cc0000' />
                        ...
                        <>
                            ...
                            <nav className='machines_gen'>
                                <ol className='machines_gen_list'>
                                    <li className='machines_gen_list_dropdown'>
                                        <button className='machines_gen_list_dropdown_button'>Gen I</button>
                                        <div className='machines_gen_list_dropdown_content'>
                                            <button onClick={() => setVersion('red-blue')}>Red / Blue</button>
                                            <button onClick={() => setVersion('yellow')}>Yellow</button>
                                        </div>
                                    </li>
                                    <li className='machines_gen_list_dropdown'>
                                        <button className='machines_gen_list_dropdown_button'>Gen II</button>
                                        <div className='machines_gen_list_dropdown_content'>
                                    ...
                                    <li className='machines_gen_list_dropdown'>
                                        <button className='machines_gen_list_dropdown_button'>Gen III</button>
                                        <div className='machines_gen_list_dropdown_content'>
                                    ...
                                    <li className='machines_gen_list_dropdown'>
                                        <button className='machines_gen_list_dropdown_button'>Gen IV</button>
                                        <div className='machines_gen_list_dropdown_content'>
                                    ...
                                    <li className='machines_gen_list_dropdown'>
                                        <button className='machines_gen_list_dropdown_button'>Gen V</button>
                                        <div className='machines_gen_list_dropdown_content'>
                                    ...
                                    <li className='machines_gen_list_dropdown'>
                                        <button className='machines_gen_list_dropdown_button'>Gen VI</button>
                                        <div className='machines_gen_list_dropdown_content'>
                                    ...
                                    <li className='machines_gen_list_dropdown'>
                                        <button className='machines_gen_list_dropdown_button'>Gen VII</button>
                                        <div className='machines_gen_list_dropdown_content'>
                                    ...
                                    <li className='machines_gen_list_dropdown'>
                                        <button className='machines_gen_list_dropdown_button'>Gen VIII</button>
                                        <div className='machines_gen_list_dropdown_content'>
