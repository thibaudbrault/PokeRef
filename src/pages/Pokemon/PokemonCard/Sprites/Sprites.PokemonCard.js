			...
			{pokemon?.id < 650 &&
				<PokemonSpritesSection>
					...
					<PokemonSpritesDiv>
						...
						<div>
							<img src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/back/${pokemon?.id}.gif`} alt={pokemon?.name} />
							<p>Back Default</p>
						</div>
						{pokemon?.sprites?.front_female !== null && (
							<div>
								<img src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/female/${pokemon?.id}.gif`} alt={pokemon?.name} />
								<p>Front Female</p>
							</div>
						)}
						{pokemon?.sprites?.back_female !== null && (
							<div>
								<img src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/back/female/${pokemon?.id}.gif`} alt={pokemon?.name} />
								<p>Back Female</p>
							</div>
						)}
						<div>
							<img src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/shiny/${pokemon?.id}.gif`} alt={pokemon?.name} />
							<p>Front Shiny</p>
						</div>
						<div>
							<img src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-v/black-white/animated/back/shiny/${pokemon?.id}.gif`} alt={pokemon?.name} />
							<p>Back Shiny</p>
						</div>
						{pokemon?.sprites?.front_shiny_female !== null && (
							<div>
