    ...
    return (
        <div>
            ...
            <nav className='method'>
                <button className={toggleType === 1 ? 'method_active' : 'method_element'} onClick={() => toggleTypeTable(1)}><p>Attack</p></button>
                <button className={toggleType === 2 ? 'method_active' : 'method_element'} onClick={() => toggleTypeTable(2)}><p>Defense</p></button>
            </nav>
