...
import { TypeListSection, TypeListSubtitle, TypeMovesTable, TypeMovesComment, TypeMovesData, TypeMovesName } from '../StyledTypeCard';
...
function Moves({type, moves}) {
    ...
    return (
        <TypeListSection>
            <TypeListSubtitle>{nbMoves} moves are <Span>{type.name}</Span> type</TypeListSubtitle>
            <div>
                <TypeMovesTable>
                    <THead>
                        <tr>
            ...
            {type?.name !== 'fairy' &&
                <TypeMovesComment>
                    <Span>{type.name}</Span> attacks were <Span>{type?.move_damage_class?.name}</Span> before Gen IV
                </TypeMovesComment>
            }
        </TypeListSection>
    )
