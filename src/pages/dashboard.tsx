...
import { Chart as ChartJS, ArcElement, Tooltip, Legend, ChartData, CategoryScale, LinearScale, BarElement, Title, LineElement, PointElement, Filler } from 'chart.js';
import { Bar, Line } from 'react-chartjs-2';
import { generations, types } from '@/utils/DataArrays';
import { MainDashboard } from '@/components/common/styles/Sizing';
import { DashGraph, DashList } from '@/components/pages/Dashboard/Styled.Dashboard';
import { useAbilities, useMoves, usePokedex } from '@/hooks/DataFetch';
...
function dashboard() {
    ...
    const typesData: ChartData<'bar'> = {
        ...
        datasets: [{
            label: undefined,
            data: [85, 69, 61, 61, 60, 70, 76, 106, 60, 111, 70, 51, 119, 74, 98, 69, 66, 146],
            backgroundColor: [
                '#9eb559',
                '#555461',
                '#1085a2',
