...
import { PokedexElement, PokedexList, PokedexTypes } from '@/components/pages/Pokemon/Styled.Pokemon';
                    ...
                    <PokedexList>
                        <ul>
                            {favorites.map((f: Pokemon.Pokemon) => (
                                <PokedexElement>
                                    <Image src={f?.sprites.front_default} alt={f.name} width={96} height={96} />
